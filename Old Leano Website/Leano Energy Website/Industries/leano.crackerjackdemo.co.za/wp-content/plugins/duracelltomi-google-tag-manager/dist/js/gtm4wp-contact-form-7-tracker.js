...
function gtm4wp_prepare_cf7_data(t) {
    var e = {
        formid: "(not set)",
        inputs: []
    };
    return t && t.detail && t.detail.contactFormId && (e.formid = t.detail.contactFormId), event && event.detail && event.detail.inputs && (e.inputs = event.detail.inputs), e
}
...
! function(n, t, a) {
    for (var e in a) ! function(e) {
        t.addEventListener(e, function(t) {
            t = gtm4wp_prepare_cf7_data(t);
            n[gtm4wp_datalayer_name].push({
                event: a[e],
                formid: t.formid,
                inputs: t.inputs
            })
